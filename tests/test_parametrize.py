...
mobile_only = pytest.mark.parametrize('browser_manager', [(375, 667), (414, 896), (390, 844)], indirect=True)
desktop_only = pytest.mark.parametrize('browser_manager', [(1366, 768), (1600, 900), (1920, 1080)], indirect=True)
